...
export const Register = () => {
  ...
  return (
    <>
      <div className="max-w-md mx-auto bg-white pr-16 pl-16 pt-10 text-center ">
        <div className="card form-container bg-white rounded-lg p-10 shadow-md max-w-md w-full">
          <h2 className="text-[20px] text-black mb-5 font-bold">Register</h2>
          <form>
            ...
            <div className="captcha">
              ...
              <div className="input-container mb-5">
                ...
                />
                <button
                  className=" text-black btn w-full rounded-xl mt-2"
      ...
      <>
        <dialog id="my_modal_privacyPolicy" className="modal">
          <div className="modal-box bg-white text-xs">
            ...
            <h3 className="font-bold indent-2">Types of Data Collected</h3>
            <br />
            ...
            <h4 className="font-bold indent-3">
            ...
            <h3 className="font-bold indent-2">
            ...
            <h2 className="font-bold indent-2">
